...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net vauxn1_0_1 [get_bd_ports vauxn1_0] [get_bd_pins xadc_wiz_0/vauxn1]
  connect_bd_net -net vauxp1_0_1 [get_bd_ports vauxp1_0] [get_bd_pins xadc_wiz_0/vauxp1]
